...
import kotlinx.android.synthetic.main.rv_talent_comment_cell.view.*
 ...
 * -----------------------------------------------------------------
 * File: TalentCommentContentHolder
 * Author: Victor
 * Date: 2021/1/15 11:11
 * Description: 
 * -----------------------------------------------------------------
 */
class TalentCommentContentHolder(itemView: View) : ContentViewHolder(itemView) {
    ...
    fun bindData (data: TalentLastCommentInfo?) {
        ...
        var jobStartTime = DateUtil.transDate(data?.jobStartTime ?: "",
            "yyyy.MM.dd","MM.dd")
        var jobEndTime = DateUtil.transDate(data?.jobEndTime ?: "",
            "yyyy.MM.dd","MM.dd")
