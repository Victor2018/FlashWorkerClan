...
import com.flash.worker.module.business.view.holder.EmployerWaitSettlementContentHolder
import com.flash.worker.module.business.view.holder.EmployerWaitSettlementHeaderHolder
 ...
 * -----------------------------------------------------------------
 * File: EmployerWaitSettlementAdapter
 * Author: Victor
 * Date: 2020/12/22 18:08
 * Description: 
 * -----------------------------------------------------------------
 */
class EmployerWaitSettlementAdapter (context: Context, listener: AdapterView.OnItemClickListener) :
    ...
    override fun onCreateHeadVHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder? {
        return EmployerWaitSettlementHeaderHolder (inflate(R.layout.rv_employer_wait_settlement_header_cell, parent))
    }

    override fun onBindHeadVHolder(viewHolder: RecyclerView.ViewHolder, data: EmployerSettlementOrderInfo?, position: Int) {
        val headerViewHolder = viewHolder as EmployerWaitSettlementHeaderHolder
        headerViewHolder.bindData(headerData,showOnlyFinish)
        headerViewHolder.mOnItemClickListener = listener
    }

    override fun onCreateContentVHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return EmployerWaitSettlementContentHolder (inflate(R.layout.rv_employer_wait_settlement_cell, parent))
    }

    override fun onBindContentVHolder(viewHolder: RecyclerView.ViewHolder, data: EmployerSettlementOrderInfo?, position: Int) {
        val contentViewHolder = viewHolder as EmployerWaitSettlementContentHolder
