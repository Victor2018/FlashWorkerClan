...
import kotlinx.android.synthetic.main.rv_hire_rejected_task_cell.view.*

/*
 * -----------------------------------------------------------------
 * Copyright (C) 2020-2080, by Victor, All rights reserved.
 * -----------------------------------------------------------------
 * File: HireRejectedTaskContentHolder
 * Author: Victor
 * Date: 2020/12/22 18:10
 * Description: 
 * -----------------------------------------------------------------
 */
class HireRejectedTaskContentHolder(itemView: View) : ContentViewHolder(itemView) {
