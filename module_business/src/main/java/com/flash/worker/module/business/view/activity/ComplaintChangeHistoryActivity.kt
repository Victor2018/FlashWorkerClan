...
import kotlinx.android.synthetic.main.activity_complaint_change_history.*
 ...
 * -----------------------------------------------------------------
 * File: ComplaintChangeHistoryActivity
 * Author: Victor
 * Date: 2020/12/17 20:41
 * Description: 
 * -----------------------------------------------------------------
 */
class ComplaintChangeHistoryActivity: BaseActivity(),View.OnClickListener,
    SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener {

    companion object {
        fun  intentStart (activity: AppCompatActivity,complaintNo: String?) {
            var intent = Intent(activity, ComplaintChangeHistoryActivity::class.java)
    ...
    override fun getLayoutResource() = R.layout.activity_complaint_change_history
