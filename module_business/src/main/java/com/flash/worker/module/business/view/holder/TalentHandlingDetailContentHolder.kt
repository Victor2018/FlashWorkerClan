...
import kotlinx.android.synthetic.main.rv_talent_handling_detail_cell.view.*
 ...
 * -----------------------------------------------------------------
 * File: TalentHandlingDetailContentHolder
 * Author: Victor
 * Date: 2020/12/22 18:10
 * Description: 
 * -----------------------------------------------------------------
 */
class TalentHandlingDetailContentHolder(itemView: View) : ContentViewHolder(itemView) {
