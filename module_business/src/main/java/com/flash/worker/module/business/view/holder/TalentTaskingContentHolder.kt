...
import kotlinx.android.synthetic.main.rv_talent_tasking_cell.view.*
 ...
 * -----------------------------------------------------------------
 * File: TalentTaskingContentHolder
 * Author: Victor
 * Date: 2020/12/22 18:10
 * Description: 
 * -----------------------------------------------------------------
 */
class TalentTaskingContentHolder(itemView: View) : ContentViewHolder(itemView) {
    ...
    fun bindData (data: TaskSettlementDetailData?) {
        ...
        itemView.mTvSubmit.setOnClickListener(this)
        ...
        itemView.mTvFinishDeadline.text = "提交任务截止时间：$finishDeadline"
    }
