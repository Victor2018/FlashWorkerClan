...
import kotlinx.android.synthetic.main.rv_employer_evaluation_center_cell.view.*
 ...
 * -----------------------------------------------------------------
 * File: EmployerEvaluationCenterContentHolder
 * Author: Victor
 * Date: 2020/12/19 11:38
 * Description: 
 * -----------------------------------------------------------------
 */
class EmployerEvaluationCenterContentHolder(itemView: View) : ContentViewHolder(itemView) {
