...
import com.flash.worker.module.business.view.holder.TalentRejectedReleaseContentHolder
 ...
 * -----------------------------------------------------------------
 * File: TalentRejectedReleaseAdapter
 * Author: Victor
 * Date: 2020/12/22 18:08
 * Description: 
 * -----------------------------------------------------------------
 */
class TalentRejectedReleaseAdapter (context: Context, listener: AdapterView.OnItemClickListener) :
    ...
    override fun onCreateContentVHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return TalentRejectedReleaseContentHolder(inflate(R.layout.rv_talent_rejected_release_cell , parent))
    }

    override fun onBindContentVHolder(viewHolder: RecyclerView.ViewHolder, data: TalentReleaseInfo?, position: Int) {
        val contentViewHolder = viewHolder as TalentRejectedReleaseContentHolder
