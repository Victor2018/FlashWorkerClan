...
import kotlinx.android.synthetic.main.rv_talent_task_evaluation_center_cell.view.*
 ...
 * -----------------------------------------------------------------
 * File: TalentTaskEvaluationCenterContentHolder
 * Author: Victor
 * Date: 2020/12/19 11:38
 * Description: 
 * -----------------------------------------------------------------
 */
class TalentTaskEvaluationCenterContentHolder(itemView: View) : ContentViewHolder(itemView) {
