...
import kotlinx.android.synthetic.main.rv_talent_wait_prepaid_header_cell.view.*
import kotlinx.android.synthetic.main.rv_talent_wait_prepaid_header_p_cell.view.*
 ...
 * -----------------------------------------------------------------
 */
class TalentWaitPrepaidHeaderHolder(itemView: View): HeaderViewHolder(itemView) {
