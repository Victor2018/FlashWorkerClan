...
import kotlinx.android.synthetic.main.rv_employer_dispute_handling_cell.view.*
 ...
 * -----------------------------------------------------------------
 * File: EmployerDisputeHandlingContentHolder
 * Author: Victor
 * Date: 2020/12/22 18:10
 * Description: 
 * -----------------------------------------------------------------
 */
class EmployerDisputeHandlingContentHolder(itemView: View) : ContentViewHolder(itemView) {
