...
import kotlinx.android.synthetic.main.rv_complaint_modify_his_cell.view.*

/*
 * -----------------------------------------------------------------
 * Copyright (C) 2020-2080, by Victor, All rights reserved.
 * -----------------------------------------------------------------
 * File: ComplaintModifyHistoryContentHolder
 * Author: Victor
 * Date: 2020/12/19 11:38
 * Description: 
 * -----------------------------------------------------------------
 */
class ComplaintModifyHistoryContentHolder(itemView: View) : ContentViewHolder(itemView)  {
    ...
    fun bindData (data: DisputeHistoryInfo?, listener: AdapterView.OnItemClickListener?) {
        ...
        itemView.mTvUserName.text = "【投诉对象】${data?.talentUsername}"
