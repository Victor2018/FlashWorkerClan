...
import kotlinx.android.synthetic.main.rv_employer_task_received_header_cell.view.*
import kotlinx.android.synthetic.main.rv_employer_task_received_header_p_cell.view.*
import kotlinx.android.synthetic.main.rv_employer_task_received_header_s_cell.view.*
 ...
 * -----------------------------------------------------------------
 * File: EmployerTaskSettlementHeaderHolder
 * Author: Victor
 * Date: 2021/3/23 11:09
 * Description: 
 * -----------------------------------------------------------------
 */
class EmployerTaskReceivedHeaderHolder(itemView: View): HeaderViewHolder(itemView) {
