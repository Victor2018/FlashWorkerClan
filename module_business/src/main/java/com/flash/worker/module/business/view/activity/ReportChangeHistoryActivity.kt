...
import kotlinx.android.synthetic.main.activity_report_change_history.*
 ...
 * -----------------------------------------------------------------
 * File: ReportChangeHistoryActivity
 * Author: Victor
 * Date: 2020/12/17 20:41
 * Description: 
 * -----------------------------------------------------------------
 */
class ReportChangeHistoryActivity: BaseActivity(),View.OnClickListener,
    SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener {

    companion object {
        fun  intentStart (activity: AppCompatActivity,complaintNo: String?) {
            var intent = Intent(activity, ReportChangeHistoryActivity::class.java)
    ...
    override fun getLayoutResource() = R.layout.activity_report_change_history
