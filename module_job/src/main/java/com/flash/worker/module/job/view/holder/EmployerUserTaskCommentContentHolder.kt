...
import kotlinx.android.synthetic.main.rv_employer_user_task_comment_cell.view.*
 ...
 * -----------------------------------------------------------------
 * File: EmployerUserTaskCommentContentHolder
 * Author: Victor
 * Date: 2021/1/15 11:11
 * Description: 
 * -----------------------------------------------------------------
 */
class EmployerUserTaskCommentContentHolder(itemView: View) : ContentViewHolder(itemView) {
