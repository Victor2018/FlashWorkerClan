...
import kotlinx.android.synthetic.main.activity_employ_reward_detail.*

class EmployRewardDetailActivity : BaseActivity(), View.OnClickListener {

    companion object {
        fun  intentStart (activity: AppCompatActivity,data: BalanceFlowInfo?) {
            var intent = Intent(activity, EmployRewardDetailActivity::class.java)
    ...
    override fun getLayoutResource() = R.layout.activity_employ_reward_detail
    ...
    fun showBalanceFlowDetail (data: BalanceFlowDetailReq) {
        ...
        mTvRewardAmount.text = AmountUtil.addCommaDots(data.data?.actualAmount)
