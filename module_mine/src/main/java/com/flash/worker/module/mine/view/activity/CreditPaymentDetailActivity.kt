...
import kotlinx.android.synthetic.main.activity_credit_payment_detail.*

class CreditPaymentDetailActivity : BaseActivity(), View.OnClickListener {

    companion object {
        fun  intentStart (activity: AppCompatActivity,data: BalanceFlowInfo?) {
            var intent = Intent(activity, CreditPaymentDetailActivity::class.java)
    ...
    override fun getLayoutResource() = R.layout.activity_credit_payment_detail
