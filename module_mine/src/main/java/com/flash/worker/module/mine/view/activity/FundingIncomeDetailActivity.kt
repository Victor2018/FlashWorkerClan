...
class FundingIncomeDetailActivity : BaseActivity(), View.OnClickListener {

    companion object {
        fun  intentStart (activity: AppCompatActivity,data: BalanceFlowInfo?) {
            var intent = Intent(activity, FundingIncomeDetailActivity::class.java)
    ...
    override fun getLayoutResource() = R.layout.activity_funding_income_detail
