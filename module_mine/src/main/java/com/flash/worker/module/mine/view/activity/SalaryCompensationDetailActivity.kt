...
import kotlinx.android.synthetic.main.activity_salary_compensation_detail.*

class SalaryCompensationDetailActivity : BaseActivity(), View.OnClickListener {

    companion object {
        fun  intentStart (activity: AppCompatActivity,data: BalanceFlowInfo?) {
            var intent = Intent(activity, SalaryCompensationDetailActivity::class.java)
    ...
    override fun getLayoutResource() = R.layout.activity_salary_compensation_detail
