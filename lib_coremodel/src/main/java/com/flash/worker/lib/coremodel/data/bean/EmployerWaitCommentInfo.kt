 ...
 * -----------------------------------------------------------------
 * File: EmployerWaitCommentInfo
 * Author: Victor
 * Date: 2021/2/8 16:56
 * Description: 
 * -----------------------------------------------------------------
 */
class EmployerWaitCommentInfo: Serializable {
    ...
    var finishType: Int = 0//结束类型：1-雇主关闭；2-雇用完成
    var totalSettledAmount:Double = 0.0//结算合计
    var totalCompensationAmount:Double = 0.0//奖励合计
