 ...
 * -----------------------------------------------------------------
 * File: EmployerJobFinishInfo
 * Author: Victor
 * Date: 2021/2/8 16:56
 * Description: 
 * -----------------------------------------------------------------
 */
class EmployerJobFinishInfo: Serializable {
    ...
    var closeTime:	String? = null//关闭时间
    var finishType: Int? = null//结束类型：1-雇主关闭；2-雇用完成
    var totalSettledAmount: Double = 0.0// 结算合计
    var totalCompensationAmount: Double = 0.0//赔付合计
    var totalReceivedCompensationAmount: Double = 0.0//获赔合计
